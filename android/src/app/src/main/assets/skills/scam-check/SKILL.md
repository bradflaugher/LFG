...
1. **Verdict first**: `Likely scam`, `Suspicious — be careful`, or
   `Probably legit, but verify`. Be decisive.
2. **The tells** — point to the concrete red (or green) flags you see:
   ...
   - Generic greetings, odd grammar, too-good-to-be-true offers, unverifiable
     claims.
3. **What to do** — concrete next steps: don't click/reply, contact the
