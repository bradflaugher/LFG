...
import com.bradflaugher.lfe.common.SkillTryOutChip
import com.bradflaugher.lfe.common.getJsonResponse
import com.bradflaugher.lfe.data.AllowedSkill
import com.bradflaugher.lfe.data.DataStoreRepository
import com.bradflaugher.lfe.data.SkillAllowlist
...
class SkillManagerViewModel
  ...
  constructor(
      ...
      if (!skillLoaded) {
        ...
        withContext(Dispatchers.IO) {
          ...
          val builtInSelectionMap =
            dataStoreBuiltInSkills.associate {
    ...
    private fun updateSkillInDataStore(
      oldName: String,
      updatedSkill: Skill,
    ) {
