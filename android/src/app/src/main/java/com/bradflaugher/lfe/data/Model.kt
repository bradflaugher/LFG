...
data class Model(
   ...
   * - `com.bradflaugher.lfe` for builds from the GitHub source.
   * - `com.bradflaugher.lfe` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.bradflaugher.lfe/files/my_model/local_dir/
   *
