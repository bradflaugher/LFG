...
import com.bradflaugher.lfg.worker.DownloadWorker
...
class DefaultDownloadRepository(
  ...
  private fun sendNotification(
    ...
    // Download from global model manager. Open the global model manager screen.
      ...
      intent =
        Intent(Intent.ACTION_VIEW, "com.bradflaugher.lfg://global_model_manager".toUri())
      ...
      intent =
        Intent(
          Intent.ACTION_VIEW,
          "com.bradflaugher.lfg://model/$taskId/$modelName".toUri(),
        )
          .apply { flags = Intent.FLAG_ACTIVITY_NEW_TASK }
    }
