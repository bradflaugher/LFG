...
data class Model(
   ...
   * - `com.bradflaugher.lfg` for builds from the GitHub source.
   * - `com.bradflaugher.lfg` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.bradflaugher.lfg/files/my_model/local_dir/
   *
