...
// import com.bradflaugher.lfg.ui.preview.PreviewChatModel
...
import com.bradflaugher.lfg.ui.common.ModelPageAppBar
import com.bradflaugher.lfg.ui.common.copyBitmapToClipboard
import com.bradflaugher.lfg.ui.common.saveBitmapToMediaStore
import com.bradflaugher.lfg.ui.common.shareBitmap
...
/**
 * Deserializes a list of [com.bradflaugher.lfg.proto.ChatMessageProto] from persistent
 ...
 */
private fun deserializeProtoMessages(protoMessages: List<com.bradflaugher.lfg.proto.ChatMessageProto>): List<ChatMessage> {
  return protoMessages.mapNotNull { protoMsg ->
    val side =
      when (protoMsg.side) {
        com.bradflaugher.lfg.proto.ChatSideProto.CHAT_SIDE_USER -> ChatSide.USER
        com.bradflaugher.lfg.proto.ChatSideProto.CHAT_SIDE_MODEL -> ChatSide.AGENT
        com.bradflaugher.lfg.proto.ChatSideProto.CHAT_SIDE_SYSTEM -> ChatSide.SYSTEM
