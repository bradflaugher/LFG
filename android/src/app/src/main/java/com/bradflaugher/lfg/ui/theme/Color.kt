...
// LFG flame accent — the spicy uncensored energy from the launcher icon.
val lfgFlame = Color(0xFFFF3D00)
val lfgFlameContainerLight = Color(0xFFFFE0D1)
val onLfgFlameContainerLight = Color(0xFF3D0F00)
...
val tertiaryDark = Color(0xFFFF8A65)  // LFG flame-ish for spicy/uncensored vibes
val onTertiaryDark = Color(0xFF2A0F00)
val tertiaryContainerDark = Color(0xFF5C1A00)
val onTertiaryContainerDark = Color(0xFFFFE0D1)
...
val onLfgFlameContainerDark = Color(0xFFFFE0D1)
val lfgFlameContainerDark = Color(0xFF5C1A00)
